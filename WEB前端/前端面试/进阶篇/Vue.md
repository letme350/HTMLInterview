...
总结： <u>MVVM模式简化了界面与业务的依赖，解决了数据频繁更新。MVVM 在使用当中，利用双向绑定技术，使得 Model 变化时，ViewModel 会自动更新，而 ViewModel 变化时，View 也会自动变化。</u>
...
<img src="https://i.loli.net/2020/11/21/Nni3IfGXhEHe9Ds.png" alt="img"  />
...
![img](https://i.loli.net/2020/11/21/uYHOLIBxUGahqtj.png)
...
![img](https://i.loli.net/2020/11/21/yKh7HtE3fUXIzb6.png)

> `modules`：项目特别复杂的时候，可以让每一个模块拥有自己的`state`、`mutation`、`action`、`getters`，使得结构非常清晰，方便管理

![img](https://i.loli.net/2020/11/22/9kNMao7f2nrbxQh.png)
...
![img](https://i.loli.net/2020/11/22/S1UZJ5dRFu3skMK.png)
...
![img](https://i.loli.net/2020/11/22/w6WaYmRHA4XMFGC.jpg)
...
![img](https://i.loli.net/2020/11/22/bh68aLmCFoAVT3r.png)
...
![img](https://i.loli.net/2020/11/22/owh78cHyOSCWT1i.png)
...
![img](https://i.loli.net/2020/11/22/euB2D9Vsd6QUMY5.png)
...
![img](https://i.loli.net/2020/11/22/gfdFe7lSXcRy41i.png)
